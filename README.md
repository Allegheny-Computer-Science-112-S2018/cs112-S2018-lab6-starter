...
# cs112-S2018-lab6-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 6 in Computer Science 112. Since
...
You should type the command `gradle run` in the terminal window to produce
output from running the `labsix.experiment.Experiment` class. Please note that
each student will have a different implementation of the `PasswordChecker` and
thus the timing values and order of growth ratios may be different when you run
the experiment on your own computer. Also, please note that this laboratory
...
beyond an indication that the tests are passing, you should carefully inspect
each of its tests so that you understand their strategy.
...
- `RunCampaign.java` contains five `println`s to produce the experiment output.
- The system runs a valid doubling experiment to study time and order of growth.
- All of the Java classes have methods that pass the provided JUnit test suite.
- Your `reflection.md` contains at least one paragraph of writing for each question.
- Your `reflection.md` file contains a fenced code block with output from
  your tool.
- Your repository has at least five commits beyond the commit number when starting the
  assignment.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-112-S2018/cs112-S2018-lab6-starter.git
```
...
you can go to the [Computer Science 112 Lab 6
Starter](https://github.com/Allegheny-Computer-Science-112-S2018/cs112-S2018-lab6-starter)
