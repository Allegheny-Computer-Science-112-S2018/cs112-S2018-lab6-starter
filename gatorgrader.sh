...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix/experiment \
                                     --checkfiles Experiment.java --fragments "println(" --fragmentcounts 8
  determine_exit_code $?
  # --> GatorGrader CHECK: at least k "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix/experiment \
                                     --checkfiles RunCampaign.java --fragments "println(" --fragmentcounts 5
  determine_exit_code $?
